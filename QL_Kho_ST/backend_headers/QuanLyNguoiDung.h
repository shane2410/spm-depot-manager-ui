...
class QuanLyNguoiDung {
  ...
  public:
    QuanLyNguoiDung();
    ~QuanLyNguoiDung();
    bool themnguoidung(const NguoiDung &nd);
    ...
    NguoiDung *timNguoiDung(const string &tenDN);
    bool xoaNguoiDung(const string &tenDN);
    bool capNhatNguoiDung(const NguoiDung &nd);
};
#endif
